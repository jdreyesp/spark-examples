package com.sundogsoftware.sparkstreaming.logParser.structured_streaming
...
object StructuredStreaming {
   ...
   def main(args: Array[String]) {
      ...
      val rawData: DataFrame = spark.readStream.text("/Users/tl39to/workspaces/spark/SparkStreamingExamples/src/main/scala/com/sundogsoftware/sparkstreaming/logParser/structured_streaming/logs")
      ...
      val logDataSet: Dataset[LogEntry] = rawData.flatMap(parseLog)
      val structuredData = logDataSet.select("status", "dateTime")
